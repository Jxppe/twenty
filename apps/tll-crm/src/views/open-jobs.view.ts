...
export default defineView({
  ...
  fields: [
    ...
    { universalIdentifier: '1ea3e207-26f4-4a7f-b3a5-024db9327ecf', fieldMetadataUniversalIdentifier: opportunity.fields.stage.universalIdentifier, position: 1, isVisible: true, size: 130 },
    { universalIdentifier: '980e5570-1192-4039-a7f9-e878e1b80ac7', fieldMetadataUniversalIdentifier: MATTER_PRACTICE_AREA_FIELD_UNIVERSAL_IDENTIFIER, position: 2, isVisible: true, size: 160 },
    ...
    { universalIdentifier: 'daa6c18e-18f4-4013-bae2-dd1251f3aab1', fieldMetadataUniversalIdentifier: opportunity.fields.company.universalIdentifier, position: 4, isVisible: true, size: 160 },
    { universalIdentifier: '6bd8e043-b8e3-4761-b3ff-0e1d44bc3089', fieldMetadataUniversalIdentifier: opportunity.fields.pointOfContact.universalIdentifier, position: 5, isVisible: true, size: 160 },
    { universalIdentifier: 'f1094166-ae65-42b8-9b9e-a6799450f2c9', fieldMetadataUniversalIdentifier: MATTER_BILLING_ENTITY_FIELD_UNIVERSAL_IDENTIFIER, position: 6, isVisible: true, size: 150 },
    { universalIdentifier: 'e3b68cbc-b990-4eaa-9124-7809404cce7c', fieldMetadataUniversalIdentifier: MATTER_OPENED_AT_FIELD_UNIVERSAL_IDENTIFIER, position: 7, isVisible: true, size: 140 },
  ],
  sorts: [
