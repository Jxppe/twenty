...
import { MATTER_BOOKINGS_FIELD_UNIVERSAL_IDENTIFIER } from 'src/constants/universal-identifiers';

export default defineViewField({
  universalIdentifier: getJobViewFieldUniversalIdentifier(MATTER_BOOKINGS_FIELD_UNIVERSAL_IDENTIFIER),
