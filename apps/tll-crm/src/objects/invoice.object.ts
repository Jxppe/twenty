...
export default defineObject({
  ...
  fields: [
    ...
    { universalIdentifier: INVOICE_SUBTOTAL_FIELD_UNIVERSAL_IDENTIFIER, type: FieldType.CURRENCY, name: 'subtotal', label: 'Subtotal', icon: 'IconSum', defaultValue: { amountMicros: null, currencyCode: "'THB'" } },
    { universalIdentifier: INVOICE_DISCOUNT_FIELD_UNIVERSAL_IDENTIFIER, type: FieldType.CURRENCY, name: 'discount', label: 'Discount', icon: 'IconDiscount', defaultValue: { amountMicros: null, currencyCode: "'THB'" } },
    { universalIdentifier: INVOICE_TAX_FIELD_UNIVERSAL_IDENTIFIER, type: FieldType.CURRENCY, name: 'tax', label: 'Tax', icon: 'IconPercentage', defaultValue: { amountMicros: null, currencyCode: "'THB'" } },
    { universalIdentifier: INVOICE_TOTAL_FIELD_UNIVERSAL_IDENTIFIER, type: FieldType.CURRENCY, name: 'total', label: 'Total', icon: 'IconCoin', defaultValue: { amountMicros: null, currencyCode: "'THB'" } },
    { universalIdentifier: INVOICE_AMOUNT_PAID_FIELD_UNIVERSAL_IDENTIFIER, type: FieldType.CURRENCY, name: 'amountPaid', label: 'Paid', icon: 'IconCashBanknote', defaultValue: { amountMicros: null, currencyCode: "'THB'" } },
