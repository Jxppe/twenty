...
export default defineObject({
  ...
  fields: [
    ...
    { universalIdentifier: QUOTATION_SUBTOTAL_FIELD_UNIVERSAL_IDENTIFIER, type: FieldType.CURRENCY, name: 'subtotal', label: 'Subtotal', icon: 'IconSum' },
    { universalIdentifier: QUOTATION_DISCOUNT_FIELD_UNIVERSAL_IDENTIFIER, type: FieldType.CURRENCY, name: 'discount', label: 'Discount', icon: 'IconDiscount' },
    { universalIdentifier: QUOTATION_TAX_FIELD_UNIVERSAL_IDENTIFIER, type: FieldType.CURRENCY, name: 'tax', label: 'Tax', icon: 'IconPercentage' },
    { universalIdentifier: QUOTATION_TOTAL_FIELD_UNIVERSAL_IDENTIFIER, type: FieldType.CURRENCY, name: 'total', label: 'Total', icon: 'IconCoin' },
