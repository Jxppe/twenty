...
export default defineField({
  universalIdentifier: PERSON_WORK_LOGS_FIELD_UNIVERSAL_IDENTIFIER,
  objectUniversalIdentifier: STANDARD_OBJECT_UNIVERSAL_IDENTIFIERS.person.universalIdentifier,
  type: FieldType.RELATION,
  name: 'workLogs',
  label: 'Work logs',
  description: 'Time recorded against this client',
  icon: 'IconClockEdit',
  relationTargetObjectMetadataUniversalIdentifier: WORK_LOG_OBJECT_UNIVERSAL_IDENTIFIER,
  relationTargetFieldMetadataUniversalIdentifier: WORK_LOG_PERSON_FIELD_UNIVERSAL_IDENTIFIER,
  universalSettings: {
