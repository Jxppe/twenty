...
export default defineField({
  universalIdentifier: WORKSPACE_MEMBER_CONVERSATIONS_FIELD_UNIVERSAL_IDENTIFIER,
  ...
  description: 'Conversations assigned to this member',
  icon: 'IconMessages',
  relationTargetObjectMetadataUniversalIdentifier: CONVERSATION_OBJECT_UNIVERSAL_IDENTIFIER,
  relationTargetFieldMetadataUniversalIdentifier: CONVERSATION_ASSIGNEE_FIELD_UNIVERSAL_IDENTIFIER,
  universalSettings: {
